...
int main(int argc, char *argv[]) {
  ...
  if(rank == MASTER) {
   ...
   // int Nz = 0;
    ...
    if(runseeder == 1) {
      if(argc != 8) {
        printf("First tiem:usage: bluebottle -s N a d E s o t r Ny Nz\n");
       ...
       // printf("       Ny is the number of particles in y direction\n");
	//printf("       Nz is the number of particles in z direction\n");
	 return EXIT_FAILURE;
      }
     ...
     // Nz = atoi(argv[9]);
      ...
      if(NP < 1 || radius < 0 || density < 0
        ...
        printf("Second time:Usage: bluebottle -s N a d o t r\n");
        printf("       N is the number of particles\n");
        printf("       a is the particle radius\n");
        printf("       d is the particle density (rho)\n");
        printf("       E is the particle Young's modulus\n");
      ...
      seeder(NP,radius, density, YoungsModulus, PoissonsRatio, order, translating, rotating);
      return EXIT_SUCCESS;
